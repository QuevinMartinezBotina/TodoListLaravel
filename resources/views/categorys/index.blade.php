...
@section('content')
    <div class="container w-50 shadow-lg border p-4 my-4">
        <div class="row mx-auto">
            <form class="" action="{{ route('categorys.store') }}" method="POST">
                @csrf
                @if (session('success'))
                ...
                <div class="mb-3">
                    <label for="color" class="form-label">Color de categoría</label>
                    ...
                    <div class="row py-1">
                        <div class="col-md-9 d-flex align-items-center">
                            <a class="d-flex align-items-center gap-2"
                                href="{{ route('categorys.show', ['category' => $category->id]) }}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('categorys.destroy', ['category' => $category->id]) }}">
                                        @method('DELETE')
                                        @csrf
